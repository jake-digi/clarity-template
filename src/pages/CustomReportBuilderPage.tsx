...
import {
  ...
  Download, FileText, Plus, Trash2, ShoppingCart, Building2, Package,
} from "lucide-react";
...
const DATA_SOURCES: DataSourceDef[] = [
  {
    id: "sales_orders",
    label: "Sales Orders",
    description: "All orders with order number, date, status, customer and gross value.",
    icon: ShoppingCart,
    table: "sales_orders",
    columns: [
      { key: "order_number", label: "Order Number", type: "text" },
      { key: "order_date", label: "Order Date", type: "date" },
      { key: "customer_order_number", label: "Customer Order Ref", type: "text" },
      { key: "status", label: "Status", type: "text" },
      { key: "items_gross", label: "Total Gross (£)", type: "number" },
      { key: "items_net", label: "Total Net (£)", type: "number" },
      { key: "items_tax", label: "Total Tax (£)", type: "number" },
      { key: "account_ref", label: "Account Ref", type: "text" },
      { key: "name", label: "Customer Name", type: "text" },
      { key: "del_name", label: "Delivery Name", type: "text" },
  ...
  {
    id: "customer_stats",
    label: "Customers (with order stats)",
    description: "Customer list with total orders, total spent and last order date.",
    icon: Building2,
  ...
  },
  {
    ...
    description: "Order lines with product, quantity, unit price and amounts.",
    icon: Package,
    ...
    columns: [
      ...
      { key: "qty_order", label: "Qty Ordered", type: "number" },
      { key: "qty_allocated", label: "Qty Allocated", type: "number" },
      { key: "qty_delivered", label: "Qty Delivered", type: "number" },
