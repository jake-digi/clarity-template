  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-3">
        ...
        <div className="lg:col-span-4 bg-card rounded-lg border border-border p-8">
        ...
        {/* App Card — 1/5 */}
        <div className="lg:col-span-1 bg-card rounded-lg border border-border p-4 flex flex-col items-center">
          <div className="flex items-center gap-1.5 mb-3">
            <Smartphone className="w-3.5 h-3.5 text-muted-foreground" />
            <span className="text-xs font-semibold text-foreground">Checkpoint App</span>
          </div>
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button size="sm" variant="outline" className="gap-1.5 h-7 text-xs mt-3 w-full max-w-[180px]">
                <Send className="w-3 h-3" /> Send Invite Link
              </Button>
            </DialogTrigger>
